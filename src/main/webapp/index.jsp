...
<html>
    <head>
        <meta charset="UTF-8">
        <title>LeFranchi | Dashboard</title>
        ...
        <!-- Theme style -->
        <link href="resources/css/LeFranchi.css" rel="stylesheet" type="text/css" />
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            <a href="index-theme.jsp" class="logo">
        ...
        <!-- LeFranchi App -->
        <script src="resources/js/LeFranchi/app.js" type="text/javascript"></script>
        
        <!-- LeFranchi dashboard demo (This is only for demo purposes) -->
        <script src="resources/js/LeFranchi/dashboard.js" type="text/javascript"></script>        
